...
const (
	UserService_FindAll_FullMethodName                = "/pb.user.UserService/FindAll"
	UserService_FindById_FullMethodName               = "/pb.user.UserService/FindById"
	UserService_FindByActive_FullMethodName           = "/pb.user.UserService/FindByActive"
	UserService_FindByTrashed_FullMethodName          = "/pb.user.UserService/FindByTrashed"
	UserService_Create_FullMethodName                 = "/pb.user.UserService/Create"
	UserService_Update_FullMethodName                 = "/pb.user.UserService/Update"
	UserService_TrashedUser_FullMethodName            = "/pb.user.UserService/TrashedUser"
	UserService_RestoreUser_FullMethodName            = "/pb.user.UserService/RestoreUser"
	UserService_DeleteUserPermanent_FullMethodName    = "/pb.user.UserService/DeleteUserPermanent"
	UserService_RestoreAllUser_FullMethodName         = "/pb.user.UserService/RestoreAllUser"
	UserService_DeleteAllUserPermanent_FullMethodName = "/pb.user.UserService/DeleteAllUserPermanent"
)
