...
const (
	CategoryService_FindByActive_FullMethodName               = "/pb.category.CategoryService/FindByActive"
	CategoryService_FindByTrashed_FullMethodName              = "/pb.category.CategoryService/FindByTrashed"
	CategoryService_FindAll_FullMethodName                    = "/pb.category.CategoryService/FindAll"
	CategoryService_FindById_FullMethodName                   = "/pb.category.CategoryService/FindById"
	CategoryService_Create_FullMethodName                     = "/pb.category.CategoryService/Create"
	CategoryService_Update_FullMethodName                     = "/pb.category.CategoryService/Update"
	CategoryService_TrashedCategory_FullMethodName            = "/pb.category.CategoryService/TrashedCategory"
	CategoryService_RestoreCategory_FullMethodName            = "/pb.category.CategoryService/RestoreCategory"
	CategoryService_DeleteCategoryPermanent_FullMethodName    = "/pb.category.CategoryService/DeleteCategoryPermanent"
	CategoryService_RestoreAllCategory_FullMethodName         = "/pb.category.CategoryService/RestoreAllCategory"
	CategoryService_DeleteAllCategoryPermanent_FullMethodName = "/pb.category.CategoryService/DeleteAllCategoryPermanent"
)
